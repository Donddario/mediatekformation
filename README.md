...
Cette version de l'application permet d'administrer son contenu. Elle contient les fonctionnalités globales suivantes :<br><br>
...
Le bas de page contient un lien pour accéder à la page des CGU : ce lien est présent en bas de chaque page excepté la page des CGU.<br><br>
...
en modifier une ainsi qu'en supprimer une, uniquement après confirmation client.<br><br>
...
ainsi que la playlist à laquelle elle doit appartenir. Les autres champs sont facultatifs. Une fois les champs remplis, nous pouvons cliquer sur ajouter, ou bien retour.<br><br>
...
Une fois les champs modifiés à notre guise, nous pouvons appuyer sur le bouton modifier pour prendre en compte les modifications, ou appuyer sur retour.<br><br>
...
Une fois les champs remplis, nous pouvons cliquer sur ajouter, ou bien retour.<br><br>
...
Cette page affiche la gestion des catégories. Nous avons la possibilité d'ajouter une catégorie dans un mini formulaire. Nous pouvons voir la liste des catégories avec un bouton "Supprimer" qui permet de supprimer une catégorie après confirmation client.<br><br>
